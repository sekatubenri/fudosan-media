...
const SITE = {
  name: '不動産投資ナビ',
  url: 'https://fudosan-select.com',
};

const AFFILIATE_TOP = `
<div style="background:#eff6ff;border:2px solid #1d4ed8;border-radius:8px;padding:16px;margin:24px 0;">
  <p style="font-weight:bold;color:#1e3a8a;margin:0 0 8px;">【PR】おすすめ不動産投資サービスを今すぐ比較</p>
  <ul style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:8px;">
    <li style="color:#374151;font-size:14px;">※ 現在アフィリエイトリンクを準備中です。最新の比較情報は各不動産投資会社の公式サイトをご確認ください。</li>
  </ul>
</div>`;

const AFFILIATE_BOTTOM = `
<div style="background:#fffbeb;border:2px solid #d97706;border-radius:8px;padding:16px;margin:24px 0;">
  <p style="font-weight:bold;color:#92400e;margin:0 0 12px;">📚 不動産投資の参考書籍</p>
  <ul style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:8px;">
    ...
    <li><a href="https://www.amazon.co.jp/dp/4478116652?linkCode=ll2&tag=mirainikibouw-22&ref_=as_li_ss_tl" rel="nofollow" target="_blank" style="color:#1d4ed8;text-decoration:underline;">▶ 不動産投資の教科書【Amazon】</a></li>
  </ul>
</div>`;
...
async function generateArticle() {
  ...
  const message = await client.messages.create({
    ...
    messages: [{
      role: 'user',
      content: `あなたは不動産投資メディア「${SITE.name}」の専門ライターです。
